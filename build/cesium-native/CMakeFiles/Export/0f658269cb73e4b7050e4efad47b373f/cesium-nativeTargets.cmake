...
add_library(CesiumUtility SHARED IMPORTED)

set_target_properties(CesiumUtility PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
...
add_library(CesiumGltf SHARED IMPORTED)

set_target_properties(CesiumGltf PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumImage;CesiumUtility"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target CesiumGeometry
add_library(CesiumGeometry SHARED IMPORTED)
...
add_library(CesiumGeospatial SHARED IMPORTED)

set_target_properties(CesiumGeospatial PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumGeometry;CesiumUtility"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target CesiumJsonReader
add_library(CesiumJsonReader SHARED IMPORTED)
...
add_library(CesiumJsonWriter SHARED IMPORTED)
...
add_library(CesiumGltfContent SHARED IMPORTED)
...
add_library(CesiumGltfReader SHARED IMPORTED)

set_target_properties(CesiumGltfReader PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumAsync;CesiumGltf;CesiumImage;CesiumJsonReader;draco::draco"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target CesiumGltfWriter
add_library(CesiumGltfWriter SHARED IMPORTED)

set_target_properties(CesiumGltfWriter PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumGltf;CesiumImage;CesiumJsonWriter"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target CesiumAsync
add_library(CesiumAsync SHARED IMPORTED)

set_target_properties(CesiumAsync PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumUtility;spdlog::spdlog;Async++"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target Cesium3DTiles
add_library(Cesium3DTiles SHARED IMPORTED)
...
add_library(Cesium3DTilesReader SHARED IMPORTED)
...
add_library(Cesium3DTilesWriter SHARED IMPORTED)
...
add_library(Cesium3DTilesContent SHARED IMPORTED)

set_target_properties(Cesium3DTilesContent PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Cesium3DTiles;Cesium3DTilesReader;CesiumAsync;CesiumGeometry;CesiumGeospatial;CesiumGltf;CesiumGltfContent;CesiumGltfReader;CesiumUtility"
)

# Create imported target CesiumRasterOverlays
add_library(CesiumRasterOverlays SHARED IMPORTED)

set_target_properties(CesiumRasterOverlays PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumAsync;CesiumGeospatial;CesiumGeometry;CesiumGltf;CesiumGltfContent;CesiumImage;CesiumJsonReader;CesiumJsonWriter;CesiumUtility;nonstd::expected-lite;spdlog::spdlog"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target Cesium3DTilesSelection
add_library(Cesium3DTilesSelection SHARED IMPORTED)

set_target_properties(Cesium3DTilesSelection PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Cesium3DTiles;Cesium3DTilesContent;Cesium3DTilesReader;CesiumAsync;CesiumGeospatial;CesiumGeometry;CesiumGltf;CesiumGltfReader;CesiumImage;CesiumQuantizedMeshTerrain;CesiumRasterOverlays;CesiumUtility;CesiumVectorData;spdlog::spdlog;libmorton::libmorton;draco::draco;nonstd::expected-lite"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target CesiumClientCommon
add_library(CesiumClientCommon SHARED IMPORTED)

set_target_properties(CesiumClientCommon PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumAsync;CesiumUtility"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target CesiumIonClient
add_library(CesiumIonClient SHARED IMPORTED)
...
# Create imported target CesiumImage
add_library(CesiumImage SHARED IMPORTED)

set_target_properties(CesiumImage PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumUtility"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
...
add_library(CesiumITwinClient SHARED IMPORTED)

set_target_properties(CesiumITwinClient PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumAsync;CesiumUtility;CesiumClientCommon;CesiumGeometry;CesiumGeospatial;CesiumVectorData"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target CesiumQuantizedMeshTerrain
add_library(CesiumQuantizedMeshTerrain SHARED IMPORTED)
...
add_library(CesiumVectorData SHARED IMPORTED)

set_target_properties(CesiumVectorData PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "Cesium3DTilesReader;CesiumUtility;CesiumGeometry;CesiumGeospatial;CesiumAsync;CesiumGltf;CesiumGltfContent;CesiumImage"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target CesiumVectorOverlays
add_library(CesiumVectorOverlays SHARED IMPORTED)

set_target_properties(CesiumVectorOverlays PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GLM_FORCE_XYZW_ONLY;GLM_FORCE_EXPLICIT_CTOR;GLM_FORCE_INTRINSICS;GLM_ENABLE_EXPERIMENTAL;CESIUM_SHARED=ON"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include;${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "CesiumUtility;CesiumGeometry;CesiumGeospatial;CesiumAsync;CesiumGltf;CesiumGltfContent;CesiumImage;CesiumVectorData;Cesium3DTilesSelection;CesiumRasterOverlays"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)
